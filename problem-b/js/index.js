...
function handleDobInput() {
  const birth = dobInput.value;
  const age = getYearsSince(birth);
...
function checkValidity() { if (form.classList.contains('was-validated')) { button.disabled = !form.checkValidity(); } }
